...
import nhb.system.platform.dataaccess.dao.system.ISysUserDao;
...
public class SysUserService {
    ...
    public Page<SysUser> findByParentIdAndBeenDelete(String parentId, int i, Pageable pageable) {
        return sysUserDao.findByParentIdAndBeenDelete(parentId, i, pageable);
    }
