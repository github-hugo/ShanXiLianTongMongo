...
public enum SystemLogMethodsTypeEnum {
	...
	SYSTEM_LOGIN("SYSTEM_LOGIN", "登录系统"), SYSTEM_RESET_PASSWORD("SYSTEM_RESET_PASSWORD", "重置密码"), SYSTEM_ADD_USER(
			"SYSTEM_ADD_USER",
			"新增用户"), SYSTEM_MODIFY_PASSWORD("SYSTEM_MODIFY_PASSWORD", "修改密码"), SYSTEM_MODIFY_USER("SYSTEM_MODIFY_USER",
					"修改用户信息"), SYSTEM_DELETE_USER("SYSTEM_DELETE_USER", "删除用户"), SYSTEM_LOGOUT("SYSTEM_LOGOUT", "退出系统"),

	SYSTEM_ADD_AREA("SYSTEM_ADD_AREA", "新增区域"), SYSTEM_MODIFY_AREA("SYSTEM_MODIFY_AREA", "修改区域信息"), SYSTEM_DELETE_AREA(
			"SYSTEM_DELETE_AREA", "删除区域"), SYSTEM_BIND_AREADEVICE("SYSTEM_BIND_AREADEVICE", "绑定区域设备"),

	SYSTEM_BIND_USERAREA("SYSTEM_BIND_USERAREA", "绑定用户区域"), SYSTEM_BIND_USERCOLLECTOR("SYSTEM_BIND_USERCOLLECTOR",
			"绑定用户采集器"),

	SYSTEM_UPDATE_UNITRATE("SYSTEM_UPDATE_UNITRATE", "费率修改"),

	DEVICE_ADD_COLLECTOR("DEVICE_ADD_COLLECTOR", "新增采集器"), DEVICE_UPDATE_COLLECTOR("DEVICE_UPDATE_COLLECTOR",
			"修改采集器"), DEVICE_DELETE_COLLECTOR("DEVICE_DELETE_COLLECTOR",
