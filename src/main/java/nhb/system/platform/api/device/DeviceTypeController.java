...
public class DeviceTypeController {
	...
	public RestResultDto save(@RequestBody DeviceType deviceType) {
		...
		try {
			...
			List<DeviceType> types = deviceTypeService.findByDeviceTypeCodeAndUserId(deviceTypeCode, userId);
	...
	public RestResultDto findAll(@RequestBody DeviceType deviceType) {
		...
		try {
			...
			List<DeviceType> deviceTypes = deviceTypeService.findByUserId(userId);
			data = deviceTypes;
			msg = "设备类型查询成功！";
		} catch (Exception e) {
			result = RestResultDto.RESULT_FAIL;
