...
import nhb.system.platform.request.data.DataAnalyzeRequest;
import nhb.system.platform.request.data.EconomyRequest;
...
public class DataAnalyzeController {
	...
	public RestResultDto analyzeTB(@RequestBody DataAnalyzeRequest request) {
		...
		try {
			...
			List<EnergyCusume> cusumesList = energyCusumeService.findByDeviceIdInAndDateBetween(deviceIds, startDate,
					endDate);
	...
	public RestResultDto analyzeHB(@RequestBody DataAnalyzeRequest request) {
		...
		try {
			...
			List<EnergyCusume> startMonthCusumes = energyCusumeService.findByDeviceIdInAndDateBetween(deviceIds,
					startMonthFirstData, startMonthEndData);

			List<EnergyCusume> endMonthCusumes = energyCusumeService.findByDeviceIdInAndDateBetween(deviceIds,
					endMonthFirstData, endMonthEndData);
	 ...
	 */
	@SuppressWarnings({ "rawtypes", "unchecked" })
	@ApiOperation(value = "同一设备节电信息", notes = "参数：economyDeviceId,economyStartDate,economyEndDate,uneconomyStartData,uneconomyEndData")
	...
	public RestResultDto economyOne(@RequestBody EconomyRequest request) {
		...
		try {
			...
			List<EnergyCusume> economyCusumes = energyCusumeService.findByDeviceIdAndDateBetween(economyDeviceId,
					economyStartDate, economyEndDate);

			List<EnergyCusume> uneconomyCusumes = energyCusumeService.findByDeviceIdAndDateBetween(economyDeviceId,
					uneconomyStartData, uneconomyEndData);
			...
			mapValue.put("economyRate", (uneconomyDeviceEnergy - economyDeviceEnergy) / uneconomyDeviceEnergy);
	 ...
	 */
	@SuppressWarnings({ "rawtypes", "unchecked" })
	@ApiOperation(value = "不同设备节电信息", notes = "参数：economyDeviceId,uneconomyDeviceId,economyStartDate,economyEndDate")
	...
	public RestResultDto economyTwo(@RequestBody EconomyRequest request) {
		...
		try {
			...
			List<EnergyCusume> uneconomyCusumes = energyCusumeService.findByDeviceIdAndDateBetween(uneconomyDeviceId,
					economyStartDate, economyEndDate);
