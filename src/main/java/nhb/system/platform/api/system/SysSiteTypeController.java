...
import nhb.system.platform.dataaccess.service.system.SysSiteTypeService;
...
public class SysSiteTypeController {
	...
	public RestResultDto save(@RequestBody SysSiteType sysSiteType) {
		...
		try {
			...
			List<SysSiteType> siteTypes = sysSiteTypeService.findBySiteCodeAndUserId(siteTypeCode, userId);
