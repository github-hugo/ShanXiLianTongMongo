...
import nhb.system.platform.dataaccess.service.system.LogEntityService;
...
import nhb.system.platform.enums.SystemLogMethodsTypeEnum;
import nhb.system.platform.enums.SystemLogMoudleTypeEnum;
import nhb.system.platform.request.system.SysLogRequest;
...
public class LogController {
	...
	public RestResultDto findLog(@RequestBody SysLogRequest request) {
		...
		try {
			...
			Page<LogEntity> pageList = logEntityService.findByUserIdInAndModuleAndMethodAndCommitAndDateBetween(userIds,
					module, methods, commit, startTime, endTime, pageable);
